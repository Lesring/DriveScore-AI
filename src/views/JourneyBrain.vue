...
<template>
  <div class="min-h-screen relative overflow-hidden page-bg" data-highlight="blueprint">
    <div class="absolute inset-0 bg-gradient-theme"></div>
    
    <NavBar title="Journey Brain" :showBack="true" @back="router.push('/')" />
        ...
        <div class="grid lg:grid-cols-3 gap-6">
          <div class="lg:col-span-1 space-y-6">
            <div class="glass-card p-6">
              <h3 class="text-primary-theme font-semibold mb-4 flex items-center gap-2">
              ...
              <div v-if="missionData" class="space-y-4">
                <div class="flex items-center gap-3">
                  ...
                  <div>
                    <div class="text-muted-theme text-sm">Destination</div>
                    <div class="text-primary-theme font-semibold">{{ missionData.destination }}</div>
                  </div>
                </div>
                ...
                <div class="flex items-center gap-3">
                  ...
                  <div>
                    <div class="text-muted-theme text-sm">Estimated Time</div>
                    <div class="text-primary-theme font-semibold">{{ missionData.estimatedTime }} min</div>
                  </div>
                </div>
                ...
                <div class="flex items-center gap-3">
                  ...
                  <div>
                    <div class="text-muted-theme text-sm">Traffic</div>
                    <div class="text-primary-theme font-semibold">{{ missionData.traffic }}</div>
                  </div>
                </div>
                ...
                <div class="flex items-center gap-3">
                  ...
                  <div>
                    <div class="text-muted-theme text-sm">Mood</div>
                    <div class="text-primary-theme font-semibold">{{ missionData.mood }}</div>
                  </div>
                </div>
              </div>
              ...
              <div v-else class="space-y-2">
                <div v-for="i in 6" :key="i" class="flex items-center gap-3">
                  <div class="w-5 h-5 bg-glass-border rounded"></div>
                  <div class="flex-1 h-4 bg-glass-border rounded"></div>
                </div>
              </div>
            </div>
          ...
          <div class="lg:col-span-1">
            <div class="glass-card p-6 h-full">
              <div class="flex items-center gap-3 mb-6">
                <h3 class="text-primary-theme font-semibold text-center flex-1">Journey Blueprint</h3>
                <span 
              ...
              <div v-if="aiGeneratedSteps.length > 0" class="space-y-1">
                <div 
                  ...
                  :class="{
                    'bg-glass-bg': currentStep === step.id,
                ...
                >
                  ...
                  <div class="flex-1">
                    ...
                    <div class="text-muted-theme text-sm">{{ step.type }} - {{ step.speed }} km/h</div>
                    <div v-if="step.emotion" class="text-muted-theme text-xs mt-1">Emotion: {{ step.emotion }}</div>
                  </div>
              ...
              <div v-else class="space-y-2">
                <div v-for="i in 5" :key="i" class="flex items-center gap-3 p-3 bg-glass-bg rounded-xl">
                  <div class="w-12 h-12 bg-glass-border rounded-xl"></div>
                  <div class="flex-1">
                    <div class="h-4 bg-glass-border rounded w-24"></div>
                    <div class="h-3 bg-glass-bg rounded w-32 mt-1"></div>
                  </div>
                </div>
              </div>
              
              <div class="mt-6 h-2 bg-glass-border rounded-full overflow-hidden">
                <div 
              ...
              <div class="text-center text-muted-theme text-sm mt-2">
          ...
          <div class="lg:col-span-1">
            <div class="glass-card p-6 h-full">
              ...
              <div class="space-y-3 max-h-[400px] overflow-y-auto">
                <div 
                  ...
                  :class="{
                    ...
                    'bg-glass-bg': currentReasoning !== step.text && index < reasoningSteps.findIndex(s => s.text === currentReasoning),
                ...
                >
                  <div 
                    ...
                    :class="{
                      ...
                      'bg-glass-border': index > reasoningSteps.findIndex(s => s.text === currentReasoning)
                    }"
                  ></div>
                  <div>
                    <div 
                    class="text-sm"
                    :class="{
                      'text-primary-theme': currentReasoning === step.text || index < reasoningSteps.findIndex(s => s.text === currentReasoning),
                      'text-muted-theme': index > reasoningSteps.findIndex(s => s.text === currentReasoning)
                    }"
                  >
                      {{ step.text }}
                    </div>
              ...
              <div v-if="!isProcessing" class="mt-6 p-4 bg-green-500/20 rounded-xl">
                ...
                <p class="text-secondary-theme text-sm">Journey blueprint generated successfully.</p>
              </div>
            </div>
          </div>
        </div>
